...
const EditWorkingExperience = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        const response = await dispatch(addAndUpdateWorkingExperience(updateExperienceData, navigate));
        if (response.success) {
    ...
    return (
        <>
            ...
            <Paper sx={{ padding: '40px', borderRadius: '10px' }}>
                <Typography variant='h5' sx={{ color: 'black', mb: 3 }}>Update Working Experience</Typography>
